        ...
        <div>
            <div className="tile">
                ...
                <div className="text">
                    ...
                    <a href="https://www.youtube.com/watch?v=djKXLt7kv7Q" className="animate-text">Learn more: https://www.youtube.com/watch?v=djKXLt7kv7Q</a>
                    <div className="dots">
                        <span></span>
                        <span></span>
                        <span></span>
            ...
            <div className="tile">
                ...
                <div className="text">
                    ...
                    <a href="https://www.youtube.com/watch?v=GZbfZ033f74" className="animate-text">Learn more: https://www.youtube.com/watch?v=GZbfZ033f74</a>
                    <div className="dots">
                        <span></span>
                        <span></span>
                        <span></span>
            ...
            <div className="tile">
                ...
                <div className="text">
                    ...
                    <a href="https://www.youtube.com/watch?v=ph3pddpKzzw" className="animate-text">Learn more: https://www.youtube.com/watch?v=ph3pddpKzzw</a>
                    <div className="dots">
                        <span></span>
                        <span></span>
                        <span></span>
            ...
            <div className="tile">
                ...
                <div className="text">
                    ...
                    <a href="https://www.youtube.com/watch?v=hXTc1mDnZCw" className="animate-text">Learn more: https://www.youtube.com/watch?v=hXTc1mDnZCw</a>
                    <div className="dots">
                        <span></span>
                        <span></span>
                        <span></span>
            ...
            <div className="tile">
                ...
                <div className="text">
                    ...
                    <a href="https://www.youtube.com/watch?v=O94yEoGXtBY" className="animate-text">Learn more: https://www.youtube.com/watch?v=O94yEoGXtBY</a>
                    <div className="dots">
                        <span></span>
                        <span></span>
                        <span></span>
