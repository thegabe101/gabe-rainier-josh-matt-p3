    ...
    <div>
      <div className="tile">
        ...
        <div className="text">
          ...
          <a href="https://www.youtube.com/watch?v=qEwKCR5JCog" className="animate-text">Learn more: https://www.youtube.com/watch?v=qEwKCR5JCog</a>
          <div className="dots">
            <span></span>
            <span></span>
            <span></span>
      ...
      <div className="tile">
        ...
        <div className="text">
          ...
          <a href="https://www.youtube.com/watch?v=Y_7aHqXeCfQ" className="animate-text">Learn more: https://www.youtube.com/watch?v=Y_7aHqXeCfQ</a>
          <div className="dots">
            <span></span>
            <span></span>
            <span></span>
      ...
      <div className="tile">
        ...
        <div className="text">
          ...
          <a href="https://www.youtube.com/watch?v=d_KZxkY_0cM" className="animate-text">Learn more: https://www.youtube.com/watch?v=d_KZxkY_0cM</a>
          <div className="dots">
            <span></span>
            <span></span>
            <span></span>
      ...
      <div className="tile">
        ...
        <div className="text">
          ...
          <a href="https://www.youtube.com/watch?v=axoeDmW0oAY" className="animate-text">Learn more: https://www.youtube.com/watch?v=axoeDmW0oAY</a>
          <div className="dots">
            <span></span>
            <span></span>
            <span></span>
      ...
      <div className="tile">
        ...
        <div className="text">
          ...
          <a href="https://www.youtube.com/watch?v=yN6Q1UI_xkE" className="animate-text">Learn more: https://www.youtube.com/watch?v=yN6Q1UI_xkE</a>
          <div className="dots">
            <span></span>
            <span></span>
            <span></span>
      ...
      <div className="tile">
        ...
        <div className="text">
          ...
          <a href="https://www.youtube.com/watch?v=v_ZkxWzYnMc" className="animate-text">Learn more: https://www.youtube.com/watch?v=v_ZkxWzYnMc</a>
          <div className="dots">
            <span></span>
            <span></span>
            <span></span>
